...
#   - Clean up the old ref: refs/top-bases/OLD (added by imz@altlinux.org)
...
# imz@altlinux.org:
# 
# This is a poor-man's variant for it, which works only for leaves
# (i.e., branches that have no dependents, thus omitting the step
# with a "for"-loop above.)
...
# Going through the receipe,
# leaving the things not implemented as comments.
# 
#   - Have a clean state before beginning.
#   - Assert NEW doesn't already exist.
